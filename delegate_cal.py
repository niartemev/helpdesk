...
class Worker(QRunnable):
    ...
    @pyqtSlot()
    def run(self):
        self.orgs[self.window.clientBox.currentIndex()].delegate_cal(self.manage,self.sendas, self.sendonbehalf, self.forwarding, self.fromUser, self.toUser, self.remove)
